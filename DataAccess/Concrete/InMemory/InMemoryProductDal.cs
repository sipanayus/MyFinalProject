...
namespace DataAccess.Concrete.InMemory
{
    public class InMemoryProductDal : IProductDal
    {
        ...
        public void Delete(Product product)
        {
            ...
            _products.Remove(productToDelete);  // _product.Remove(product); //referans değerinden dolayı silmez
        ...
        {
            Product productToUpdate = _products.SingleOrDefault(p => p.ProductId == product.ProductId); //Gönderiğim ürün id'sine sahip olan listedeki ürünü bul
